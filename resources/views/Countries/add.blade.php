...
<input type="text" name="Country_Name" class="form-control" id="exampleInputName1" value="{{old('Country_Name')}}" placeholder="Country Name">
...
<input type="text" name="Country_Code" class="form-control" id="exampleInputPassword4" value="{{old('Country_Code')}}" placeholder="Country Code">
